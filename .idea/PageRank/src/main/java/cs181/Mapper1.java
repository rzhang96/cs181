...
public class Mapper1 extends Mapper<LongWritable, Text, Text, Text> {      
	...
	public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
		...
		Text outputKey = new Text(indicesAndValue[0] == "M" ? indicesAndValue[2] : indicesAndValue[1]);
		Text outputValue = new Text(indicesAndValue[0] == "M" ? indicesAndValue[0] + "\t" + indicesAndValue[1] + "\t" + indicesAndValue[3] :
				indicesAndValue[0] + "\t" + indicesAndValue[2]);
