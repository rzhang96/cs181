...
public class WordCountMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
	    ...
	    public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
	    	String[] stopWordsArr = {"i","a","about","an","and,","are","as","at","be","by","for","from",
		    ...
		    //all stop words can be added here. Or we can read in a list of stopwords, in WordCount and use that by reading it into a set
		    //HashSets are used because they do .contain in O(1) time. 
